...
class StudentProfileLogic extends ChangeNotifier {
  ...
  // Mock student data - matches Philippine education context
  final Map<String, dynamic> _studentData = {
    ...
    'bio': 'I am a Grade 7 student passionate about mathematics and science. I enjoy learning new things and participating in school activities. My goal is to excel in my studies and contribute positively to our school community.',
  ...
  final List<Map<String, dynamic>> _weeklySchedule = [
    {
      'day': 'Monday',
      'schedule': [
        {'time': '7:30 AM - 8:30 AM', 'subject': 'Mathematics 7', 'room': 'Room 101'},
        {'time': '8:30 AM - 9:30 AM', 'subject': 'Science 7', 'room': 'Room 102'},
        {'time': '9:30 AM - 10:30 AM', 'subject': 'English 7', 'room': 'Room 103'},
        {'time': '10:30 AM - 11:30 AM', 'subject': 'Filipino 7', 'room': 'Room 104'},
        {'time': '1:00 PM - 2:00 PM', 'subject': 'Araling Panlipunan 7', 'room': 'Room 105'},
    ...
    },
    {
      ...
      'schedule': [
        ...
        {'time': '2:00 PM - 3:00 PM', 'subject': 'Values Education', 'room': 'Room 107'},
      ],
    },
    {
      'day': 'Wednesday',
  ...
  final List<Map<String, dynamic>> _enrolledCourses = [
    {'code': 'MATH7', 'name': 'Mathematics 7', 'teacher': 'Maria Santos', 'grade': 94},
    {'code': 'SCI7', 'name': 'Science 7', 'teacher': 'Juan Cruz', 'grade': 92},
    {'code': 'ENG7', 'name': 'English 7', 'teacher': 'Ana Reyes', 'grade': 91},
    {'code': 'FIL7', 'name': 'Filipino 7', 'teacher': 'Pedro Santos', 'grade': 93},
    {'code': 'AP7', 'name': 'Araling Panlipunan 7', 'teacher': 'Rosa Garcia', 'grade': 90},
    {'code': 'MAPEH7', 'name': 'MAPEH 7', 'teacher': 'Carlos Ramos', 'grade': 95},
    {'code': 'TLE7', 'name': 'TLE 7', 'teacher': 'Linda Torres', 'grade': 92},
    {'code': 'VE7', 'name': 'Values Education', 'teacher': 'Sofia Martinez', 'grade': 94},
  ];
