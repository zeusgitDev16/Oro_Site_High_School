-- ============================================
-- FIX INFINITE RECURSION - CORRECT ORDER
-- Drop policies FIRST, then drop function
-- ============================================
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for parent_students';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for courses';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for attendance';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for assignments';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for submissions';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for grades';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for messages';
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'Created policy for notifications';
    END IF;
END $$;
...
BEGIN
  ...
  RAISE NOTICE '  • Dropped all policies first';
